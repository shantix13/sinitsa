...
$('#ck-filialz .filial.red .locator').click(function () {
    $.fancybox.open({
        src: '#locate-form-1',
        type: 'inline',
        modal: true,
...
$('#ck-filialz .filial.green .locator').click(function () {
    $.fancybox.open({
        src: '#locate-form-2',
        type: 'inline',
        modal: true,
...
$('#ck-filialz .filial.blue .locator').click(function () {
    $.fancybox.open({
        src: '#locate-form-3',
        type: 'inline',
        modal: true,
